...
#define MEM_ALLOC_WAIT(size, wait_option)                                                          \
    ({                                                                                             \
        void *_ptr = NULL;                                                                         \
        UINT  _status;                                                                             \
        _status = tx_byte_allocate(&tx_app_byte_pool, &_ptr, (size), (wait_option));               \
        _status != TX_SUCCESS ? NULL : _ptr;                                                       \
    })

#define user_malloc(size) MEM_ALLOC_WAIT(size, TX_NO_WAIT)
